...
import { UserAccountIcon, PencilEdit01Icon, Camera01Icon } from "@hugeicons/core-free-icons";
        ...
        <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
                    <div className="relative shrink-0">
                        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#49A5A2] to-[#3d8d8a] flex items-center justify-center shadow-[0_4px_20px_rgba(73,165,162,0.4)]">
                            <span className="text-white text-[28px] font-bold">R</span>
                        </div>
                    ...
                    <div className="text-center sm:text-left">
                        <p className="text-white text-[18px] font-semibold">Raj Kumar</p>
                        <p className="text-white/40 text-[13px] mt-1">raj.kumar@email.com</p>
                        <p className="text-white/30 text-[12px] mt-0.5">+91 98765 43210</p>
                    </div>
                </div>
            </div>
            ...
            <div className="rounded-xl border border-white/[0.08] bg-[#1a1a1a]/60 p-6 space-y-5">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <button className="flex items-center gap-1.5 text-[#49A5A2] text-[13px] font-medium hover:text-[#5ab5b2] transition-colors cursor-pointer">
                ...
                {[
                    ...
                    { label: "Email Address", value: "raj.kumar@email.com" },
